...
def main():
    ...
    while True:
        ...
        if len(lms_list) != 0:
            ...
            x20,y20 = lms_list[20][1], lms_list[20][2]
            if lms_list[4][2] < lms_list[8][2]:
                break
            elif x5 in range (64,576) and y5 in range(96,388) and math.hypot(x5-x4, y5-y4) > 20 :
                pg.moveTo(1920 - int((x5 - 64) * 3.75), int((y5 - 96) * 3.75))
            elif math.hypot(x12-x8, y12-y8) < 20:
                pg.click()
            elif math.hypot(x12-x16, y12-y16) < 20:
                pg.rightClick()
        cv2.rectangle(img, (64, 96), (576, 388), (255, 0, 255), 1)
